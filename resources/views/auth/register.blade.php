            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Numéro de mobile') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="token_registration" class="col-md-4 col-form-label text-md-right">{{ __('Token') }}</label>

                            <div class="col-md-6">
                                <input id="token_registration" type="text" class="form-control{{ $errors->has('token_registration') ? ' is-invalid' : '' }}" name="token_registration" value="{{ old('token_registration') }}" required autofocus>

                                @if ($errors->has('token_registration'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('token_registration') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Genre') }}</label>
